...
describe("<AboutMe />", () => {
    ...
    it("should render the portfolio download link with correct properties", () => {
        render(<AboutMe />);
        const portfolioLink = screen.getByText("Download my Curriculum Vitae") as HTMLAnchorElement;

        expect(portfolioLink).toBeInTheDocument();
        expect(portfolioLink).toHaveAttribute("download", "Curriculum Vitae - Felipe Santiago Morais");
