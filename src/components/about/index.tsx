      ...
      <div className="content">
        ...
        <div className="aboutMe">
          <p className="summarize">
            Since starting my programming journey in July 2023, I've been deeply
            immersed in web development, focusing on HTML, CSS, JavaScript, and
            React JS. After a while, I adopt TypeScript and that was
            transformative, to enhance the code quality. I'm driven by the
            opportunity to use emerging technologies to solve problems and
            simplify daily tasks for people.
          </p>
            ...
            <ul className="abilitiesList">
              <li className="ability">
                ...
                <div>
                  ...
                  <p>
                    I create responsive web desing and dynamic functionalities,
                    focused on React, to improve user experiences and
                    interfaces.
                  </p>
                </div>
              </li>
              <li className="ability">
                ...
                <div>
                  <h4>TypeScript</h4>
                  <p>
                    Adopting TypeScript on my projects has been transformative,
                    enhancing code quality, minimizing bugs, and boosting
                    security.
                  </p>
                </div>
              </li>
              <li className="ability">
                ...
                <div>
                  ...
                  <p>
                    Utilizing Vitest, React Testing Library, and Jest, I can
                    refine my code, ensuring seamless functionality and
                    minimizing errors on my front-end projects.
                  </p>
                </div>
              </li>
            </ul>
...
const Container = styled.section`
  ...
  .content {
    ...
    .title {
      padding: 2rem;
      border: 0.1rem solid ${({ theme }) => theme.textColor};
      width: 100%;
      text-align: center;
