...
export const Projects = () => {
  ...
  const personalPortfolio = useGitHubAutomatedRepos(
    "SantiagoMorais",
    "personal-portfolio"
  );
    ...
    <Container id="myProjects" theme={theme}>
      <div className="content">
        ...
        <p className="portfolioDescription">
          This portfolio was developed using React and TypeScript, powered by
          the Vite application. Integrative tests are currently being
          implemented using Vitest and React Testing Library. Finally, the
          project's styling is being crafted with the Style-Components library.
          <br />
          See my the github repository of my personal portfolio
          <a
            className="personalPortfolioLink"
            href={personalPortfolio[0]?.html_url}
            target="_blank"
          >
            {" "}
            here
        ...
        >
          <p className="buttonLabel">
            See more projects on my GitHub Repository
          </p>
        </a>
      </div>
    </Container>
